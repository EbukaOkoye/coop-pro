        ...
        <div className="p-4 bg-white min-h-screen">
            ...
            <div className="mt-6 p-4">
                <div className="bg-white p-4 rounded-tl-[0.625rem] rounded-tr-[0.625rem] shadow-sm">
                    <h1 className="font-monty font-semibold text-lg leading-5 text-btn_blue underline underline-offset-8">Personal Savings</h1>
                </div>
                <form className="mt-10">
                    ...
                    <div className="md:w-auto mt-6 md:ml-8">
                        <div className="flex items-center gap-2">
                            <p className="font-monty font-normal text-sm leading-4 text-grey_82">Add a new transaction</p>
                            <FaPlusSquare size={16} color="#109CF1" />
                        </div>
                        <CustomButton text='Continue' className='bg-btn_blue text-white px-6 py-2 rounded-[0.3125rem] mt-3 md:w-[15.625rem]' />
                    </div>
                </form>
            </div>
        </div>
