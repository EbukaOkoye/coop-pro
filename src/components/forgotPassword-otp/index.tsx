                ...
                <>
                    {countdown === 0 ? (
                        <div className="mt-6 flex items-center gap-2 justify-center">
                            <p className="font-normal text-[1rem] leading-6 grey_text text-grey_82">
                                Didn’t receive the OTP?
                            </p>
                            <p className="red_text text-red-600 underline underline-offset-[0.5rem] cursor-pointer">Resend</p>
                        </div>
                    ) : (
                        <p
